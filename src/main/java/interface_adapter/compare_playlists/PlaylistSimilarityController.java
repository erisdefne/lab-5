...
public class PlaylistSimilarityController {
    ...
    private PlaylistsInputBoundary playlistsInputBoundary;
    ...
    public void comparePlaylists(String playlist1Name, String playlist1Owner,
        ...
        PlaylistsInputData inputData = new PlaylistsInputData(playlist1Name, playlist1Owner, playlist2Name, playlist2Owner);
